  ...
  const data = {
    ...
    navMain: [
      ...
      },
      {
        ...
        icon: <HouseIcon />,
        items: [
          { title: "Cozy Home Design", url: "/" },
          { title: "Small Apartment Living", url: "/" },
          { title: "Bedroom Comfort", url: "/" },
          { title: "Reading Nooks", url: "/" },
          { title: "Balcony Spaces", url: "/" },
          { title: "Calm Corners", url: "/" },
          { title: "Lighting & Ambience", url: "/" },
          { title: "Minimal Interiors", url: "/" },
          { title: "Seasonal Decor", url: "/" },
        ],
      },
      {
        title: "Slow Living",
      ...
      },
      {
        ...
        items: [
          { title: "About", url: "/" },
          { title: "Editorial Philosophy", url: "/" },
          { title: "Writing Process", url: "/" },
          { title: "Why This Journal Exists", url: "/" },
        ],
      },
    ],
